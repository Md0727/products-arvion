                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li>
                                <Link to="/products/auriqua" className="text-muted-foreground hover:text-foreground transition-colors">
                                    Auriqua Collection
                                </Link>
                            </li>
                            <li>
                                <Link to="/products/monarch" className="text-muted-foreground hover:text-foreground transition-colors">
                                    Monarch Collection
                                </Link>
                            </li>
                        </ul>
